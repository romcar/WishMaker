...
(function () {
    ...
    function handleMetric(metric) {
        ...
        console.log(`✅ Collected ${metric.name}: ${displayVal}${unit}`);
        // { changed code }
    ...
    // Use dynamic ES module import to load the ESM bundle and call its named exports.
    (async function loadWebVitalsESM() {
        try {
            const mod = await import(
                'https://unpkg.com/web-vitals@2/dist/web-vitals.esm.js'
            );
            ...
            console.log('📦 web-vitals (ESM) loaded.');
        } catch (err) {
            console.warn('⚠️ Failed to import web-vitals ESM:', err);
            console.log(
                '💡 If ESM import is blocked in this environment, consider using the UMD bundle instead.'
            );
        }
    })();
